...
If you're upgrading from fluent-asserts v1.x, see the [Upgrading to v2.0.0](/guide/upgrading-v2/) guide for migration steps and breaking changes.

## Next Steps

- Learn about [Assertion Styles](/guide/assertion-styles/)
- Configure [Output Formats](/guide/configuration/) for different environments
